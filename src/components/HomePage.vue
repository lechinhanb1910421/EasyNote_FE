...
<template>
  <div class="container text-dark" style="padding-top: 70px">
    <h1>Hello {{ useUser.user.name }}</h1>
    <h3>Your email address is: {{ useUser.user.email }}</h3>
    <p>
    ...
    <p>
      What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
      dummy text ever since the 1500s, when an unknown printer took a galley of type and Letraset sheets containing Lorem Ipsum passages, and more
